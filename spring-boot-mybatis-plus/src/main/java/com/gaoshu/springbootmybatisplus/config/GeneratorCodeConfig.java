package com.gaoshu.springbootmybatisplus.config;
...
//        mpg.setTemplateEngine(new FreemarkerTemplateEngine());
    ...
    private static DataSourceConfig getDataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/test?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true");
